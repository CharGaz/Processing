/* autogenerated by Processing revision 1293 on 2024-11-21 */
...
public void getYoutube(String url){
  try {
...
public void drawPlaylist(int i, int x, int y){
...
public void playlistCreateDisplay() {
    drawSongs();
    int x = 275; 
    int y = 50;  //
